...
class MoonPhongMesh(
    ...
    fun draw(
        ...
        GLES20.glVertexAttribPointer(aTexCoordinate, 2, GLES20.GL_FLOAT, false, 0, texCoordBuffer)
        ...
        GLES20.glUniform3fv(uViewPos, 1, viewPos, 0)
    ...
    companion object {
        ...
        private const val FRAGMENT_SHADER = """
            ...
            void main() {
                ...
                vec3 diffuse = diff * texColor * vec3(1.0, 1.0, 1.0);
